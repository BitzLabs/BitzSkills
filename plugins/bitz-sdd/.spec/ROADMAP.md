...
- テーマ6〜12（テストトレーサビリティ、`ROADMAP.md`成果物化、ユースケース工程、
  ライフサイクル解説、sandbox、帰属追随、採番方式）についても同じ3分類で裁定する。
  これらは機能追加を含むため、構造再設計と一括でスコープへ入れない。
...
- [ ] テーマ6〜12のV4スコープ帰属（必須 / 準備 / V4後）が裁定済み
