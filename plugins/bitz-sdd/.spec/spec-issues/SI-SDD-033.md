...
- **対象ファイル**: `plugins/bitz-sdd/skills/sdd-core/scripts/spec_status.py`、
  ...
  `plugins/bitz-sdd/skills/sdd-core/references/gates.md`、
  `tests/test_spec_status.py`、`tests/test_spec_labels.py`、SDD-FR-136 の改訂または後継要件、
  関連する設計成果物、bitz-sdd マニフェスト。
- **確認観点**:
