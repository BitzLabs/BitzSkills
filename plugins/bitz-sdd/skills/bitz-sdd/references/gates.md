...
`sdd-discovery` の仮説検証（Go / No-Go / Pivot）。証跡は `.planning/discovery/assumptions.md`。No-Go / Pivot のまま Plan フェーズに進まない。
...
6. □ specs/<feature>/ を `.planning/archive/<date>-<feature>/` へアーカイブ
