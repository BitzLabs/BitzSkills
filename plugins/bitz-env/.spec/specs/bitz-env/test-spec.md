...
### テスト仕様: ENV-FR-010 生成物のトラッキングと env-destroy による撤去
...
- **検証ステータス**: 未実施（evals 実装時に横断アサーションとして組み込む）
...
| ENV-FR-003〜007 / 009 / 010 | example-test | 未実施（evals/ 未実装） | 不可 |
| ENV-CON-003 | manual-check | 未実施 | 不可 |
