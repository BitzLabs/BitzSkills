...
2.  **DDD 成熟度**: `references/ddd-maturity.md` の12基準（Strategic 30% / Tactical 45% / Architecture 25%）で採点します。
3.  **MMI**: `references/mmi-maturity.md` の4軸（Cohesion / Coupling / Independence / Reusability）でモジュールごとに採点します。
