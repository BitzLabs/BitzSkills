...
- **[文書索引 (docs/MASTER.md)](docs/MASTER.md)** — ドキュメント全体の入口。ここから各章へ辿る
- **[システム仕様](docs/01_システム仕様/システム仕様.md)** — 機能・非機能・規約制約の索引
- **[ミッション・ビジョン](docs/00_はじめに/ミッション・ビジョン.md)** — なぜ標準環境を提供するか
- **[対象外](docs/00_はじめに/対象外.md)** — BitzSkills が扱う範囲・扱わない範囲
- **[ユースケース一覧](docs/02_ユースケース/ユースケース一覧.md)** — 「何ができるか」をシナリオ別に
...
docs/                            # 人間向けナラティブ（MASTER.md + 必須6章）・調査報告・翻訳規約
