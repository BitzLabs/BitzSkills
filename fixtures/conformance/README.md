...
306 of the 311 matrix fixtures, independent golden Context Digests,
...
[Initial single-workspace fixtures](single/README.md) provide five real inputs, manifests, complete expected JSON results,
