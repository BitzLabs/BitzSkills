...
導入・設定9件、EARS 12件、[関係・path・coverageの6件](関係・path・coverage-review.md)、[ID重複・循環の4件](文書ID重複・循環review.md)、[Git基準版の5件](Git基準版・状態遷移review.md)、[保護対象外変更の5件](approved-REQの保護対象外変更review.md)と合わせて50/311件を準備した。
