...
2026-09-11追記: 導入・設定9件と[文書構造・UTF-8の9件](document-review.md)、[関係・path・coverageの6件](trace-review.md)、[ID重複・循環の4件](graph-review.md)、[Git基準版の5件](git-review.md)と合わせて45/311件を準備済み。
残266件とgolden Context Digest等があるためGate AはBlockedのままとする。
