...
| Matrix inventory | 311 IDs, no duplicate or family/suffix collision; 36 prepared, 275 real fixtures missing |
...
Read-only before/after expectations are fixed for the nine introduction/config, twelve EARS, nine document and six trace cases; the remaining cases still need expectations.
