...
| Matrix inventory | 311 IDs, no duplicate or family/suffix collision; 16 prepared, 295 real fixtures missing |
| EARS fixtures | SINGLE-007, 008, 009-01/02/03, 010-01/02: fixed REQ bytes, Frontmatter Schema, complete expected results, Unicode token positions and two isolated setups checked; position/severity/count/input corruption rejected |
...
Read-only before/after expectations are fixed for the nine introduction/config and seven EARS cases; the remaining cases still need expectations.
