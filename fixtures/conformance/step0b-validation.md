...
| Matrix inventory | 311 IDs, no duplicate or family/suffix collision; 45 prepared, 266 real fixtures missing |
...
Read-only before/after expectations are fixed for the nine introduction/config, twelve EARS, nine document, six trace, four graph and five Git cases; the remaining cases still need expectations.
