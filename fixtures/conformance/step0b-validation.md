...
| Matrix inventory | 311 IDs, no duplicate or family/suffix collision; 40 prepared, 271 real fixtures missing |
...
Read-only before/after expectations are fixed for the nine introduction/config, twelve EARS, nine document, six trace and four graph cases; the remaining cases still need expectations.
