...
- **依存**: なし。
- **実施**: 2026-07-16 ラッパー案（提案1）を CORE-FR-011（scripts/spec によるバージョン非依存
  解決）へ要件化し実装（CORE-TSK-012）。PR #41 でマージ。その後 SI-CORE-034 により
  Claude / Codex 横断解決へ改版し（CORE-TSK-025、コミット e83c3eb）、2026-07-27 に
  CORE-FR-011 promoted。
