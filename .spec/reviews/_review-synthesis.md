---
view_of: CORE-REV-002
path: CORE-REV-002.md
updated: 2026-07-30
---
...
- **最新**: [CORE-REV-002](CORE-REV-002.md) — SI-CORE-034 設計レビュー統合レポート（判定 PASS）
- **機械可読**: [`CORE-REV-002.json`](CORE-REV-002.json)（ポインタは `review-synthesis.json`）
