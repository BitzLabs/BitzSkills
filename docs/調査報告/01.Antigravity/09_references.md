...
本調査報告書の作成にあたり、以下のワークスペース内ドキュメントおよび外部の公式ドキュメントを参照・引用しました。

---

## 9.1 ワークスペース内の参照ソース
以下のローカルリポジトリ内のドキュメントおよびコードを解析し、仕様の定義を行いました。
...
## 9.2 外部・公式ドキュメントの参照元 URL
Antigravity の基本コンセプトや SDK、周辺エコシステム規格の記述において、以下の公開ドキュメントおよび標準化仕様を参照しました。

1.  **Google Antigravity 2.0 開発者ドキュメント (公式)**:
    *   [Google Antigravity - Skills Specification](https://antigravity.google/docs/skills)
    *   [Google Antigravity - CLI Plugins](https://antigravity.google/docs/cli/plugins)
2.  **Agent Skills オープン標準仕様**:
    *   [Agent Skills Specification](https://agentskills.io/specification)
3.  **Claude Code 開発者向けリファレンス (互換レイヤー比較用)**:
    > [!NOTE]
    > 以下は **Claude Code 専用の資料であり、Antigravity 自体への言及は含みません**。本書では互換レイヤーの挙動を Claude Code 側の仕様と対比するための参照としてのみ用いており、Antigravity の一次情報源ではない点に留意してください。
...
4.  **Google Cloud Vertex AI 連携ドキュメント**:
    *   [Vertex AI Agent Platform Overview](https://cloud.google.com/vertex-ai)
