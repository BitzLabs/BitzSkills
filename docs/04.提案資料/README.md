...
| [07_ユースケース・フロー遷移レビューと修正提案.md](07_ユースケース・フロー遷移レビューと修正提案.md) | 02.設計書、03.詳細設計 | **Open**（8件未裁定） |
...
## 12. ユースケース・フロー遷移レビュー（2026-08-31、未裁定）
...
| 優先度 | 件数 | 主な内容 |
|---|---:|---|
| P1 | 3 | Small Flowの実装後検査、先行TASKの状態ガード、verify bindingの重複排除 |
| P2 | 4 | code/test逆引き、Intent起点、Full Flowの戻り先、削除済みIDの保証範囲 |
| P3 | 1 | ADR部分改訂の追跡方法 |
