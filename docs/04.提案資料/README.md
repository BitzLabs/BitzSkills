...
| [07_ユースケース・フロー遷移レビューと修正提案.md](07_ユースケース・フロー遷移レビューと修正提案.md) | 02.設計書、03.詳細設計 | **一部裁定**（P1 3件裁定・反映済み、P2 4件・P3 1件未裁定） |
...
## 12. ユースケース・フロー遷移レビュー（2026-08-31、P1裁定済み）
...
| P2 | 4 | code/test逆引き、Intent起点、Full Flowの戻り先、削除済みIDの保証範囲 | 未裁定 |
| P3 | 1 | ADR部分改訂の追跡方法 | 未裁定 |

P1 3件はADR-028〜030として裁定し、正本へ反映した。
...
指摘、修正候補、反映先、受入条件、P1裁定結果は
[07_ユースケース・フロー遷移レビューと修正提案.md](07_ユースケース・フロー遷移レビューと修正提案.md)を正とする。
P2 4件とP3 1件は未裁定であり、該当する修正例をCore 1.0の実装根拠にしない。
